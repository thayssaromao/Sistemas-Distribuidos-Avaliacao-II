...
1. 2. 3. gerar um hash do conteúdo do evento;
assinar o evento utilizando criptografia assimétrica;
incluir a assinatura digital no campo Signature.
...
1. 2. 3. verificar a assinatura digital utilizando a chave pública do produtor;
confirmar que o evento não foi alterado;
processar o evento apenas se a assinatura for válida. Caso a assinatura seja
